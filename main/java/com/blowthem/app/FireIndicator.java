...
public class FireIndicator extends View {
    ...
    public FireIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void initializeAttributes(Context context, AttributeSet attrs){
        ...
        roadStrokeWidth = ta.getFloat(R.styleable.CircleRoadProgressWidget_roadStrokeWidth, 12f);
